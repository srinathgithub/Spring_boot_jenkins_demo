...
stage('Testing'){
	...
	echo 'Testing'
	properties([parameters([[$class: 'ChoiceParameter', choiceType: 'PT_SINGLE_SELECT', description: 'Testing', filterLength: 1, filterable: false, name: 'ActiveChoiceParameter', randomName: 'choice-parameter-319585721038197', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: '''one
	two'''], script: [classpath: [], sandbox: false, script: '''One
	Two
	Three
	four''']]]])])
	}
